    ...
    ***************************************************************************** */
    ...
    var VirtualTableStateBase = /*#__PURE__*/ (function (_super) {
        ...
        VirtualTableStateBase.getDerivedStateFromProps = function (nextProps, prevState) {
            var _a = nextProps.availableRowCount, availableRowCount = _a === void 0 ? prevState.availableRowCount : _a, totalRowCount = nextProps.totalRowCount, pageSize = nextProps.pageSize, infiniteScrolling = nextProps.infiniteScrolling;
            return {
                availableRowCount: dxGridCore.getAvailableRowCount(infiniteScrolling, pageSize * 2, availableRowCount, totalRowCount),
            };
        };
